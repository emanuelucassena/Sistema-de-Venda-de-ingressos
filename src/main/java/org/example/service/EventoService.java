...
import org.example.exceptions.evento.exceptions.*;
...
public class EventoService {
    ...
    public void cadastrarEvento(Usuario usuarioLogado, String nome, String descricao, String dataStr, int qtdIngresso, float valorIngresso) {

        DateTimeFormatter fmt = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        LocalDate dataEvento = LocalDate.parse(dataStr, fmt);

        if (!(usuarioLogado instanceof Administrador)) {
            throw new PermissaoNegadaException("Apenas administradores podem cadastrar eventos.");
        }
